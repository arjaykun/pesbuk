			...
			<p class="pb-3 text-gray-500 text-sm">
	 		...
	 		<form action="/register" method="POST">
			 	...
			 	<div class="mb-2">
			 		...
			 		<x-forms.input type="password" placeholder="johndoe@gmail.com" name="password"  />
			 		<x-forms.input-error name="password" />
			 	</div>

			 	<div class="mb-2">
			 		<x-forms.label text="Confirm Password" />
			 		<x-forms.input type="password" placeholder="johndoe@gmail.com" name="password_confirmation"  />
			 	</div>
