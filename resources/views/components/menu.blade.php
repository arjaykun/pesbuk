<ul class="py-2 text-sm text-gray-700 font-semibold ">
  ...
  <a href="{{ route('notifications.index') }}"><li class="px-2 bg-gray-100 py-1 rounded-md hover:bg-purple-500 my-1 hover:text-white"> 
    <svg class="w-4 inline-block mr-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  <a href="{{ route('settings.index') }}"><li class="px-2 bg-gray-100 py-1 rounded-md hover:bg-purple-500 my-1 hover:text-white">
    <svg class="w-4 inline-block mr-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
