    ...
    <div class="ml-9 hidden mt-2" :class="{'block':showReplies, 'hidden':!showReplies}">
      ...
      <div class="flex items-center mb-2">
        ...
        <form wire:submit.prevent="createReply({{ $comment->id }})" class="flex items-center w-full">
          ...
          <input type="text" class="w-full bg-gray-300 h-8 rounded-md resize-none mx-2 p-1 focus:outline-none" placeholder="Write a reply..." @if(!$edit) wire:model.lazy="reply" @endif x-ref="replyInput">
