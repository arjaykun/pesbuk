...
> 
  <div class="bg-white md:w-96 w-10/12 h-auto py-5 px-3 rounded-md z-50 mt-20">
    ...
    <p class="pb-2">Update the text below to update your comment.</p>
    ...
    <div class="grid grid-cols-2 gap-2 pt-5">
      ...
      {{-- confirm button --}}
      <x-forms.default-button type="submit" class="bg-purple-700 border-purple-700 text-white border hover:bg-white hover:text-gray-700" wire:click="updateComment" wire:loading.attr="disabled">Save Changes</x-forms.default-button>
