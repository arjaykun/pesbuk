...
<div x-data class="w-full">	
	{{-- mobile  info viewer --}}
	<div class="lg:hidden block mb-2 mt-20" wire:ignore>
		<div class="bg-white w-full">

			<div class="w-full flex justify-center relative">
				<div class="absolute w-36 h-36" style="margin-top: -80px">
			...
			<div class="py-2 text-sm rounded-md text-gray-600 text-center">
				...
				@if ($user->profile->location)
					<div class="my-1 text-center">
						...
						<div class="text-sm text-gray-700 inline-block">Lives in <span class="font-semibold">{{ $user->profile->location }}</span></div>
					</div>
				@endif
